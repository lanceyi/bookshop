...
public class BookDto extends BookEntity {
    ...
    public BookDto (Integer bookId, String bookName, String imgUrl, String bookAuthor, String bookPub, BigDecimal bookPrice, BigDecimal bookOriginalPrice,String bookSort,String bookDescription,String bookUser,Timestamp createTime,Timestamp updateTime) {
